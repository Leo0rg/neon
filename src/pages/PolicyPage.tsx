  ...
  return (
    <div className="bg-[#161616] text-white min-h-screen py-16 md:py-24">
      <div className="mx-auto px-[5%] md:px-[15%]">
        ...
        <div className="prose prose-invert max-w-none text-lg opacity-80">
          ...
          <p>
            ...
            Богородовым Владиславом Юрьевичем (далее - Оператор).
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              Пользователю веб-сайта bogorodovneon.ru);
            </li>
            <li>
              <strong>2.9. Пользователь</strong> – любой посетитель веб-сайта
              bogorodovneon.ru
            </li>
            <li>
              <strong>2.10. Предоставление персональных данных</strong> – действия,
              направленные на раскрытие персональных данных определенному лицу
              или определенному кругу лиц;
            </li>
            <li>
              <strong>2.11. Распространение персональных данных</strong> – любые
            ...
            <li>
              <strong>2.12. Трансграничная передача персональных данных</strong> –
            ...
            <li>
              <strong>2.13. Уничтожение персональных данных</strong> – любые
          ...
          <ul>
            <li><strong>3.1.</strong> Фамилия, имя, отчество Пользователя;</li>
            <li><strong>3.2.</strong> Контактный номер телефона Пользователя;</li>
            <li>
              <strong>3.3.</strong> Адрес электронной почты (e-mail)
              Пользователя;
            </li>
            <li><strong>3.4.</strong> Адрес доставки Товара Пользователя;</li>
            <li>
              <strong>3.5.</strong> Также на сайте происходит сбор и обработка
              обезличенных данных о посетителях (в т.ч. файлов «cookie») с
              помощью сервисов интернет-статистики (Яндекс Метрика и Гугл
              Аналитика и других).
            </li>
            <li>
              <strong>3.6.</strong> Вышеперечисленные данные далее по тексту
          ...
          <p>
            ...
            bogorodovneon.ru; уточнение деталей заказа.
          </p>
          <p>
            <strong>4.2.</strong> Также Оператор имеет право направлять
            ...
            bogorodov_neon@mail.ru с пометкой «Отказ от уведомлений о новых
            продуктах и услугах и специальных предложениях».
          </p>
          <p>
            <strong>4.3.</strong> Обезличенные данные Пользователей, собираемые с
          ...
          <p>
            ...
            на сайте bogorodovneon.ru Заполняя соответствующие формы и/или
          ...
          <p>
            <strong>6.1.</strong> Оператор обеспечивает сохранность персональных
            данных и принимает все возможные меры, исключающие доступ к
            персональным данным неуполномоченных лиц.
          </p>
          <p>
            <strong>6.2.</strong> Персональные данные Пользователя никогда, ни при
          ...
          <p>
            <strong>6.3.</strong> В случае выявления неточностей в персональных
            ...
            Оператора bogorodov_neon@mail.ru с пометкой «Актуализация
            персональных данных».
          </p>
          <p>
            ...
            Оператора bogorodov_neon@mail.ru с пометкой «Отзыв согласия на
            обработку персональных данных».
          </p>

          <h2>7. Трансграничная передача персональных данных</h2>
          <p>
            <strong>7.1.</strong> Оператор до начала осуществления трансграничной
          ...
          <p>
            <strong>7.2.</strong> Трансграничная передача персональных данных на
            территории иностранных государств, не отвечающих вышеуказанным
            требованиям, может осуществляться только в случае наличия согласия
            в письменной форме субъекта персональных данных на трансграничную
          ...
          <p>
            <strong>8.1.</strong> Пользователь может получить любые разъяснения по
            интересующим вопросам, касающимся обработки его персональных
            данных, обратившись к Оператору с помощью электронной почты
            bogorodov_neon@mail.ru
          </p>
          <p>
            <strong>8.2.</strong> В данном документе будут отражены любые
            изменения политики обработки персональных данных Оператором.
            Политика действует бессрочно до замены ее новой версией.
          </p>
          <p>
            <strong>8.3.</strong> Актуальная версия Политики в свободном доступе
            расположена в сети Интернет по адресу bogorodovneon.ru/policy.
          </p>
        </div>
      </div>
    </div>
